    ...
    t.fn.extend({
        scrollable: function (t) {
            ...
            return this.unbind("click.smoothscroll").bind("click.smoothscroll", function (l) {
                var o = this, r = t(this), i = t.extend({}, n, r.data("ssOpts") || {}), c = n.exclude, a = i.excludeWithin, f = 0, h = 0, u = !0, d = {}, p = location.hostname === o.hostname || !o.hostname, m = i.scrollTarget || t.smoothScroll.filterPath(o.pathname) === s, S = e(o.hash);
    ...
    Multiselect.prototype = {
        ...
        defaults: {
            ...
            templates: {
                ...
                filterClearBtn: '<span class="input-group-btn"><button class="btn btn-info multiselect-clear-filter" type="button"><i class="glyphicon glyphicon-remove"></i></button></span>',
